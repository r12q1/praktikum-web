<form onSubmit="return validasi(this)" method="post" action="<?php $_SERVER['PHP_SELF'];?>">
	<table> 
		...
		<tr>
			 <td height="35">Ingat/Tidak</td>  
			 
			 <td height="35"><select name="coba"> 
     			 <option value="Remember Login"> Remember Login 
     			 <option value="Forget Login"> Forget Login
     			 <option value="Not Both" selected = "yes" > Not Both
   			 </select></td>
		</tr>
              <tr> 
	...
	{
		echo 'Selamat Datang, ' . $_POST['user'] . '<br/>' . $_POST['coba'];
	}	 
	} 
	?>	
</form>